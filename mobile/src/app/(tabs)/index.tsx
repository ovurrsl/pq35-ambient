...
const styles = StyleSheet.create({
  ...
  basliklar: { gap: 3 },
  baslik: { fontFamily: FONTS.display, fontSize: 26 },
  altBaslik: { fontFamily: FONTS.mono, fontSize: TYPE_SCALE.micro, letterSpacing: 1.1 },
  ...
  sistemAd: { fontFamily: FONTS.bodySemiBold, fontSize: 16 },
  sistemAlt: { fontFamily: FONTS.body, fontSize: TYPE_SCALE.micro },
  ayirac: { height: StyleSheet.hairlineWidth },
  genelSatir: { flexDirection: 'row', alignItems: 'center', gap: SPACING.sm, minHeight: HIT_SIZE },
  genelEtiket: { fontFamily: FONTS.body, fontSize: TYPE_SCALE.label },
  genelKaydirac: { flex: 1, minWidth: 60 },
  genelYuzde: { fontFamily: FONTS.monoBold, fontSize: 14, minWidth: 44, textAlign: 'right' },

  grupBaslik: { flexDirection: 'row', alignItems: 'baseline', justifyContent: 'space-between', gap: SPACING.sm },
  grupNot: { fontFamily: FONTS.body, fontSize: TYPE_SCALE.micro },
  ...
  rozetMetin: { fontFamily: FONTS.monoBold, fontSize: TYPE_SCALE.micro },
  ...
  satirYuzde: { fontFamily: FONTS.mono, fontSize: TYPE_SCALE.micro, minWidth: 34, textAlign: 'right' },


  govde: { fontFamily: FONTS.body, fontSize: TYPE_SCALE.label, lineHeight: 19 },
  dipnot: { fontFamily: FONTS.body, fontSize: TYPE_SCALE.micro, lineHeight: 17 },
});
