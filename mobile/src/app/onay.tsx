...
const styles = StyleSheet.create({
  ...
  basliklar: { gap: 4 },
  ustBaslik: { fontFamily: FONTS.mono, fontSize: TYPE_SCALE.micro, letterSpacing: 1.4 },
  baslik: { fontFamily: FONTS.display, fontSize: 26 },
  ozetSatir: { flexDirection: 'row', alignItems: 'center', gap: SPACING.sm, minHeight: 30 },
  ozetEtiket: { flex: 1, fontFamily: FONTS.body, fontSize: TYPE_SCALE.label },
  ozetDeger: { fontFamily: FONTS.mono, fontSize: TYPE_SCALE.caption, textAlign: 'right' },
